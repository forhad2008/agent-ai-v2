...
export const ToolsView: React.FC = () => {
  ...
  return (
    <div id="tools_view" className="flex-1 overflow-y-auto p-3.5 sm:p-6 lg:p-8 space-y-8 max-w-7xl mx-auto w-full text-[#F8FAFC]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#10B981]/25 pb-4 sm:pb-5">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-[#F8FAFC] flex items-center gap-2.5">
            <Wrench className="h-6 w-6 text-[#00D9A5]" />
          ...
          >
            <div>
              <div className="flex items-center justify-between gap-2 mb-2">
                <span className="rounded-lg bg-[#010e09] px-2.5 py-0.5 text-[10px] font-mono text-[#94A3B8] border border-[#10B981]/20">
                  {tool.category}
                </span>
            ...
            <div className="mt-4 pt-3 flex items-center justify-between border-t border-[#10B981]/15">
              <div className="flex items-center gap-1 text-[10px] font-mono text-[#94A3B8]">
                {tool.riskLevel === 'REQUIRES_APPROVAL' ? (
                  <span className="text-[#854D0E] flex items-center gap-1 font-semibold">
      ...
      <div className="mt-10 rounded-2xl bg-[#010e09] p-6 border border-[#10B981]/25 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
          ...
          <span className="text-[10px] font-mono text-[#94A3B8] uppercase bg-[#010e09] px-2.5 py-1 rounded-lg border border-[#10B981]/20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {FUTURE_INTEGRATIONS.map((integ, idx) => (
            <div
              key={idx}
              className="flex flex-col justify-between p-3.5 rounded-xl bg-[#010e09] border border-[#10B981]/20"
            >
              <div>
              ...
              <div className="mt-3 flex items-center justify-between text-[10px]">
                <span className="rounded-lg bg-[#010e09] px-2 py-0.5 text-[#94A3B8] font-mono border border-[#10B981]/20">
                  {integ.status}
                </span>
      ...
      {testingTool && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4 backdrop-blur-sm animate-fadeIn">
          <div className="w-full max-w-2xl rounded-2xl bg-[#010e09] p-5 sm:p-6 border border-[#10B981]/35 shadow-2xl space-y-5">
            <div className="flex items-center justify-between border-b border-[#10B981]/18 pb-3">
              <div>
              ...
              <button
                ...
                className="rounded-lg p-1.5 text-[#94A3B8] hover:bg-[#010e09] hover:text-white transition-all"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="space-y-4 text-xs">
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl bg-[#010e09] p-3.5 text-[#F8FAFC] border border-[#10B981]/25 font-mono text-xs focus:outline-none focus:border-[#10B981] shadow-inner focus:ring-1 focus:ring-[#10B981]/30"
                />
              </div>

              {testResult && (
                <div className="space-y-2 border-t border-[#10B981]/15 pt-3">
                  <span className="block text-[#00D9A5] font-extrabold uppercase tracking-wider text-[10px] mb-2">
                    ...
                    <div className="space-y-3 animate-slideIn">
                      <div className="grid grid-cols-4 gap-2">
                        {[
                          ...
                          { label: 'Best Practices', val: testResult.scores?.bestPractices || 95, color: 'text-[#00D9A5] border-[#00D9A5]/30 bg-[#00D9A5]/5' }
                        ].map((score, i) => (
                      ...
                      {testResult.metadata && (
                        <div className="bg-[#010b07] p-3 rounded-xl border border-white/5 space-y-1.5 font-sans">
                      ...
                      {testResult.coreWebVitals && (
                        <div className="grid grid-cols-2 gap-2 bg-[#010b07] p-2.5 rounded-xl border border-white/5 font-mono text-[10px]">
                          <div><span className="text-[#00D9A5]">FCP Speed:</span> {testResult.coreWebVitals.fcp}</div>
                          <div><span className="text-[#00D9A5]">LCP Load:</span> {testResult.coreWebVitals.lcp}</div>
                          <div><span className="text-[#00D9A5]">Layout Shift:</span> {testResult.coreWebVitals.cls}</div>
                          <div><span className="text-[#00D9A5]">Input Delay:</span> {testResult.coreWebVitals.fid}</div>
                        </div>
                      )}
                      ...
                      {testResult.auditReport && (
                        <div className="bg-[#010b07] p-3 rounded-xl border border-white/5 max-h-40 overflow-y-auto text-[#94A3B8] font-mono text-[11px] whitespace-pre-wrap leading-relaxed">
                          {testResult.auditReport}
                        </div>
                      )}
                    </div>
                  ...
                  {testingTool.id === 'tool_sql_designer' && (
                    <div className="space-y-3 animate-slideIn font-mono text-[11px]">
                      <div className="flex items-center justify-between bg-[#010b07] p-2 rounded-xl border border-white/5 text-[10px]">
                      ...
                      {testResult.rows && (
                        <div className="border border-white/10 rounded-xl overflow-hidden bg-[#010b07]">
                          <table className="w-full text-left border-collapse">
                            <thead>
                              <tr className="bg-[#010e09] text-[#00D9A5] font-bold border-b border-white/10 text-[10px]">
                      ...
                      <div className="bg-[#010e09]/50 p-2.5 rounded-xl border border-[#10B981]/25 text-[#94A3B8] text-[10px] leading-relaxed">
                  ...
                  {testingTool.id === 'tool_prompt_optimizer' && (
                    <div className="space-y-3 animate-slideIn font-sans">
                      <div className="bg-[#010b07] p-3.5 rounded-xl border border-[#10B981]/25 space-y-2">
                        ...
                        <div className="max-h-56 overflow-y-auto text-[#F8FAFC] font-mono text-[11px] whitespace-pre-wrap leading-relaxed bg-[#010e09] p-3 rounded-lg border border-white/5">
                  ...
                  {testingTool.id !== 'tool_seo_audit' && testingTool.id !== 'tool_sql_designer' && testingTool.id !== 'tool_prompt_optimizer' && (
                    <div className="max-h-48 overflow-y-auto rounded-xl bg-[#010b07] p-3.5 font-mono text-[11px] text-[#00D9A5] border border-[#10B981]/22 whitespace-pre-wrap leading-relaxed">
            ...
            <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-[#10B981]/18">
              <button
                onClick={() => setTestingTool(null)}
                className="rounded-xl px-4.5 py-2 text-xs font-semibold text-[#94A3B8] hover:bg-[#010e09] hover:text-white transition-all cursor-pointer"
              >
                Close
              </button>
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] px-5 py-2 text-xs font-bold text-white shadow-[0_0_15px_rgba(16,185,129,0.3)] disabled:opacity-50 transition-all cursor-pointer"
              >
                {isExecuting ? (
                  <>

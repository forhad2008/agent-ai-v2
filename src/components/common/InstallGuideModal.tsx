...
export const InstallGuideModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative z-10 w-full max-w-lg overflow-hidden rounded-3xl border border-[#10B981]/30 bg-[#010e09] p-6 shadow-[0_0_50px_rgba(16,185,129,0.3)] text-[#F8FAFC]">
        {/* Decorative lighting */}
        <div className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-[#10B981]/20 blur-3xl" />
        <div className="pointer-events-none absolute -left-16 -bottom-16 h-48 w-48 rounded-full bg-[#854D0E]/15 blur-3xl" />

        {/* Header */}
        <div className="flex items-start justify-between border-b border-[#10B981]/20 pb-4">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#065f46] via-[#854D0E] to-[#10B981] text-white shadow-[0_0_15px_rgba(16,185,129,0.4)]">
        ...
        {isInstalled && (
          <div className="my-4 flex items-center gap-2 rounded-xl bg-emerald-950/40 p-3 border border-[#10B981]/30 text-emerald-300 text-xs font-semibold">
        ...
        <div className="my-4 grid grid-cols-3 gap-2.5 rounded-2xl bg-black/60 p-3 border border-white/5">
          <div className="flex flex-col items-center text-center p-1">
            <Zap className="h-4 w-4 text-[#00D9A5] mb-1" />
          ...
          <div className="flex flex-col items-center text-center p-1 border-x border-white/5">
            <Smartphone className="h-4 w-4 text-emerald-400 mb-1" />
            <span className="text-[10px] font-bold text-slate-200">
          ...
          <div className="flex flex-col items-center text-center p-1">
            <CheckCircle className="h-4.5 w-4.5 text-[#00D9A5] mb-1" />
            <span className="text-[10px] font-bold text-slate-200">
        ...
        <div className="flex border-b border-[#10B981]/20 mb-4">
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-1.5 py-2.5 text-xs font-bold uppercase tracking-wider transition-colors border-b-2 cursor-pointer ${
              activeTab === 'ios'
                ? 'border-[#10B981] text-white bg-[#10B981]/5'
        ...
        <div className="min-h-[170px] bg-black/40 rounded-2xl p-4 border border-white/5">
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2.5">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-slate-850 text-[10px] font-bold text-white">
                    1
                  </div>
                  <div>
                    ...
                    <strong className="text-[#00D9A5] inline-flex items-center gap-1 font-semibold">
          ...
          {activeTab === 'android' && (
            <div className="space-y-3.5 text-xs">
              ...
              {deferredPrompt ? (
                <div className="p-3 bg-[#10B981]/10 rounded-xl border border-[#10B981]/20 text-center space-y-2">
                  ...
                  <button
                    ...
                    className="mx-auto flex items-center gap-2 rounded-xl bg-[#10B981] px-4 py-2 text-xs font-bold text-white shadow-lg shadow-[#10B981]/30 hover:bg-[#065f46] transition cursor-pointer"
                  >
        ...
        <div className="mt-5 flex items-center justify-between border-t border-white/10 pt-4 text-[11px] text-[#94A3B8]">
          <div className="flex items-center gap-1">
            <Info className="h-3.5 w-3.5 text-[#00D9A5]" />

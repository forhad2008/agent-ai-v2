...
export const UserProfileView: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Top Banner Header */}
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-[#10B981]/20 bg-gradient-to-r from-[#01140d] via-[#14532d]/40 to-[#78350F]/20 p-5 sm:p-8 shadow-2xl">
        <div className="pointer-events-none absolute -top-20 right-0 h-80 w-80 rounded-full bg-[#10B981]/20 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-20 left-10 h-64 w-64 rounded-full bg-[#854D0E]/20 blur-3xl" />

        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-4 sm:gap-5">
            {/* User Avatar with Luxury Emerald-Brown Gradient & Facebook-style Profile Picture Upload */}
            <div className="relative group shrink-0 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full p-[3px] bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] shadow-[0_0_25px_rgba(16,185,129,0.3)] cursor-pointer overflow-hidden">
              <div className="relative flex h-full w-full items-center justify-center rounded-full bg-[#01140d] overflow-hidden">
              ...
              <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#00D9A5] border-2 border-[#01140d] text-[10px] z-10" title="Context Active">
                ✓
              </span>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="rounded-full bg-[#10B981]/25 px-2.5 py-0.5 text-[10px] sm:text-xs font-bold text-[#00D9A5] border border-[#10B981]/40">
                  {isBangla ? 'ব্যবহারকারী প্রোফাইল ও প্রসঙ্গ' : 'User Profile & Context Memory'}
                </span>
                <span className="text-[10px] text-[#00D9A5] font-semibold flex items-center gap-1">
          ...
          <div className="flex items-center gap-2 sm:gap-3 rounded-2xl bg-white/[0.04] p-3 border border-white/10 backdrop-blur-md">
            <Brain className="h-6 w-6 text-[#00D9A5] animate-pulse shrink-0" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          <form onSubmit={handleSubmit} className="rounded-2xl sm:rounded-3xl border border-white/10 bg-[#02140d]/95 p-5 sm:p-7 space-y-5 shadow-xl backdrop-blur-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/15 bg-white/[0.04] px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder-white/30 focus:border-[#10B981] focus:outline-none focus:ring-1 focus:ring-[#10B981]"
              ...
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <Briefcase className="h-3.5 w-3.5 text-[#00D9A5]" />
              ...
              <div>
                <label className="block text-xs font-semibold text-[#CBD5E1] mb-1.5 flex items-center gap-1.5">
                  <Building className="h-3.5 w-3.5 text-[#10B981]" />
            ...
            <div className="rounded-xl border border-[#10B981]/40 bg-[#10B981]/10 p-4 space-y-2">
              <label className="block text-xs font-bold text-[#00D9A5] flex items-center gap-2">
                <Bot className="h-4 w-4 text-[#00D9A5]" />
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full rounded-xl border border-white/20 bg-black/40 px-3.5 py-2.5 text-xs sm:text-sm text-white placeholder-white/30 focus:border-[#00D9A5] focus:outline-none focus:ring-1 focus:ring-[#00D9A5]"
            ...
            <div className="pt-2 flex justify-end">
              <button
                type="submit"
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] px-6 py-3 text-xs sm:text-sm font-bold text-white shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-[#02140d]/85 overflow-hidden shadow-xl animate-fadeIn">
            <div className="h-20 bg-gradient-to-r from-[#065f46] to-[#10B981] relative">
              <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#00D9A5]/20 via-transparent to-transparent" />
            </div>
            <div className="px-5 pb-5 relative flex flex-col items-center">
              <div className="relative -mt-10 mb-3 shrink-0 flex h-20 w-20 items-center justify-center rounded-full p-[3px] bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] shadow-lg">
                <div className="flex h-full w-full items-center justify-center rounded-full bg-[#01140d] overflow-hidden">
              ...
              <p className="text-xs text-[#00D9A5] font-semibold mt-0.5">{userProfile.role}</p>
          ...
          <div className="rounded-2xl sm:rounded-3xl border border-[#10B981]/30 bg-[#02140d] p-5 space-y-4 shadow-xl">
            <div className="flex items-center gap-2.5 pb-3 border-b border-white/10">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#10B981]/20 border border-[#10B981]/40 text-[#00D9A5]">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/10 space-y-1">
                <span className="text-[10px] uppercase font-mono text-[#10B981] font-bold block">User Identity</span>
              ...
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/10 space-y-1">
                <span className="text-[10px] uppercase font-mono text-[#00D9A5] font-bold block">Custom Directive</span>

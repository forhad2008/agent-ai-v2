...
const ThinkingTraceSection: React.FC<{ thinkingText: string }> = ({ thinkingText }) => {
  ...
  return (
    <div className="my-2.5 overflow-hidden rounded-xl bg-[#02140d]/70 border border-[#00D9A5]/25 shadow-sm transition-all">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="flex w-full items-center justify-between px-3.5 py-2 text-left text-[11px] font-bold uppercase tracking-wider text-[#00D9A5] hover:bg-[#10B981]/15 transition-colors focus:outline-none"
      >
        <div className="flex items-center gap-2">
          <div className="relative flex h-3.5 w-3.5 items-center justify-center">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#10B981] opacity-35"></span>
            <span className="relative inline-flex h-2 w-2 rounded-full bg-[#00D9A5]"></span>
          </div>
          <span className="font-semibold tracking-wider text-[#00D9A5]">Agent Cognitive Thoughts</span>
        </div>
        <span className="text-[10px] text-[#94A3B8] font-mono tracking-wide">{isOpen ? 'COLLAPSE' : 'EXPAND TRACE'}</span>
      </button>
      {isOpen && (
        <div className="border-t border-[#10B981]/15 bg-[#010e09]/90 p-3 font-mono text-[11px] leading-relaxed text-[#94A3B8] whitespace-pre-wrap select-all">
          <div className="flex items-start gap-1 text-[#00D9A5] mb-1.5 font-bold tracking-tight">
...
export const ChatView: React.FC = () => {
  ...
  return (
    <div id="ai_chat_view" className="flex h-full flex-col bg-[#01140d]/90 text-[#F8FAFC]">
      {/* Chat Top Subheader */}
      <div className="flex shrink-0 items-center justify-between border-b border-[#10B981]/25 bg-[#02140d]/80 px-3.5 py-2.5 sm:px-6">
        <div className="flex items-center gap-2.5 sm:gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#10B981]/20 text-[#00D9A5] border border-[#10B981]/30">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1 rounded-full bg-[#02140d]/85 px-2 py-0.5 text-[10px] text-[#00D9A5] border border-[#10B981]/30 hover:border-[#00D9A5]"
              >
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => setIsLanguageModalOpen(true)}
            className="flex sm:hidden items-center gap-1 rounded-lg bg-[#02140d]/85 px-2 py-1 text-xs text-[#F8FAFC] border border-[#10B981]/25"
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-[#02140d]/85 px-3 py-1.5 text-xs font-medium text-[#00D9A5] border border-[#10B981]/30 hover:bg-[#10B981]/15 hover:text-white transition-colors"
          >
            <Plus className="h-3.5 w-3.5 text-[#00D9A5]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {demoSuggestions.map((item, idx) => (
                <button
                  ...
                  className="flex flex-col items-start p-3 text-left rounded-2xl bg-[#02140d]/85 border border-[#10B981]/25 hover:border-[#00D9A5]/50 hover:bg-[#10B981]/15 transition-all group shadow-sm"
                >
                  <span className="text-xs font-bold text-[#F8FAFC] group-hover:text-[#00D9A5]">
                    {item.title}
                  </span>
        ...
        <div className="mx-auto max-w-3xl space-y-6">
                ...
                <div
                  className={`relative max-w-[92%] sm:max-w-[85%] rounded-2xl p-4 sm:p-5 shadow-sm text-sm leading-relaxed transition-all duration-200 ${
                    msg.isDeleted
                      ...
                      : isUser
                        ? 'bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] text-[#F8FAFC] rounded-tr-none shadow-[0_0_20px_rgba(16,185,129,0.3)] border border-[#10B981]/40'
                        : 'bg-[#02140d]/90 text-[#F8FAFC] border border-[#10B981]/25 rounded-tl-none shadow-[0_0_30px_rgba(16,185,129,0.08)]'
                  }`}
                >
                  ...
                  {!msg.isDeleted && (
                    <div className="absolute right-2 top-2 z-20 sm:opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-150">
                      ...
                      {activeMenuId === msg.id && (
                        <div className="absolute right-0 mt-1.5 w-40 rounded-xl bg-[#02140d]/95 border border-[#10B981]/25 py-1 shadow-2xl z-30 animate-fadeIn">
                          <button
                            type="button"
                            onClick={() => {
                  ...
                  {msg.isDeleted ? (
                    ...
                    <>
                        ...
                        <div className="mt-3 rounded-xl bg-rose-950/30 p-3 border border-rose-500/40 text-xs">
                          ...
                          <div className="mt-2 text-slate-400 flex items-center justify-between pt-2 border-t border-rose-900/40">
                            ...
                            <button
                              ...
                              className="text-[#00D9A5] hover:text-[#10B981] font-bold hover:underline"
                            >
                              Retry Step
                            </button>
                          </div>
                      ...
                      {!isUser && (
                        <div className="mt-3 flex items-center gap-2 pt-2 border-t border-[#10B981]/20 text-[11px] text-slate-400">
                      <button
                        onClick={() => handleCopyText(msg.id, msg.text)}
                        className="flex items-center gap-1 rounded px-2 py-1 hover:bg-[#10B981]/15 hover:text-slate-200 transition-colors"
          ...
          {isGenerating && (
            <div className="flex flex-col items-start space-y-2">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 px-1 text-[#00D9A5]">
                <div className="flex items-center gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-[#00D9A5] animate-ping" />
                  <span className="font-semibold">{settings.agentName || 'Agent-forest08'}</span>
                </div>
              ...
              <div className="w-full max-w-[85%] rounded-2xl bg-[#02140d]/90 border border-[#10B981]/25 rounded-tl-none space-y-3">
                {activePlan && (
                  <PlanProgressCard steps={activePlan} isGenerating={true} />
                )}

                {/* Instant Action Countdown Progress Bar */}
                <div className="space-y-1 bg-[#010e09]/50 rounded-xl p-2.5 border border-white/5">
                  ...
                  <div className="w-full bg-[#010e09] rounded-full h-1.5 overflow-hidden">
                    <div 
                      className="bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] h-1.5 transition-all duration-300" 
                ...
                <div className="flex items-center gap-3 text-xs text-slate-400 pt-1">
                  <div className="flex space-x-1">
                    <div className="h-2 w-2 rounded-full bg-[#00D9A5] animate-bounce" style={{ animationDelay: '0ms' }} />
                    <div className="h-2 w-2 rounded-full bg-[#00D9A5] animate-bounce" style={{ animationDelay: '150ms' }} />
                    <div className="h-2 w-2 rounded-full bg-[#00D9A5] animate-bounce" style={{ animationDelay: '300ms' }} />
                  </div>
      ...
      {/* Input Bar & Controls */}
      <div className="shrink-0 border-t border-[#10B981]/25 bg-[#02140d] p-3 sm:p-4">
        <div className="mx-auto max-w-3xl">
          ...
          {selectedAttachedFiles.length > 0 && (
            <div className="mb-2 flex flex-wrap gap-2">
              {selectedAttachedFiles.map((file) => (
                <div
                  key={file.id}
                  className="flex items-center gap-1.5 rounded-lg bg-[#14532d]/40 px-2.5 py-1 text-xs text-[#00D9A5] border border-[#10B981]/30"
                >
                  <FileText className="h-3.5 w-3.5 text-[#00D9A5]" />
          ...
          {isRecording && (
            <div className="mb-2 flex items-center justify-between rounded-lg bg-[#065f46]/20 p-2 text-xs text-[#00D9A5] border border-[#10B981]/30 animate-pulse">
              <div className="flex items-center gap-2">
                <Mic className="h-4 w-4 text-[#00D9A5]" />
                <span>
          ...
          {/* Text Input Row */}
          <div className="relative flex items-end gap-2 rounded-2xl bg-[#010e09] p-2 border border-[#10B981]/35 focus-within:border-[#00D9A5] focus-within:ring-2 focus-within:ring-[#10B981]/20 shadow-[0_0_25px_rgba(16,185,129,0.15)] transition-all duration-300">
            ...
            <div className="relative">
              <button
                ...
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-[#94A3B8] hover:bg-[#010e09] hover:text-[#F8FAFC] transition-colors"
              ...
              {showAttachMenu && (
                <div
                  id="attach_menu"
                  className="absolute bottom-12 left-0 z-50 w-64 rounded-2xl bg-[#02140d] p-2.5 border border-[#10B981]/30 shadow-2xl space-y-1 text-xs"
                >
                  ...
                  <div className="max-h-40 overflow-y-auto space-y-1">
                    {files.map((f) => (
                      <button
                        ...
                        className="flex w-full items-center justify-between rounded-lg px-2 py-1.5 text-left text-[#F8FAFC] hover:bg-[#010e09] hover:text-[#00D9A5]"
                      >
                  ...
                  <div className="border-t border-[#10B981]/20 pt-1">
                    <button
                      type="button"
                      onClick={() => fileInputRef.current?.click()}
                      className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-left text-[#00D9A5] hover:bg-[#010e09]"
                    >
            ...
            <button
              ...
              className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition-colors ${
                isRecording
                  ...
                  : 'text-[#94A3B8] hover:bg-[#010e09] hover:text-[#F8FAFC]'
              }`}
            ...
            <textarea
              ...
              rows={1}
              className="flex-1 max-h-32 resize-none bg-transparent py-2.5 px-2 text-sm text-[#F8FAFC] placeholder:text-[#94A3B8]/60 focus:outline-none caret-[#00D9A5] transition-all duration-150"
            />
            ...
            {isGenerating ? (
              ...
              <button
                ...
                className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition-all ${
                  input.trim()
                    ? 'bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] text-[#F8FAFC]'
                    : 'bg-[#010e09] text-[#94A3B8]/40 border border-[#10B981]/15 cursor-not-allowed'
                }`}

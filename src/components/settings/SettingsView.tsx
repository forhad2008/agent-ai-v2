...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div id="settings_view" className="flex-1 overflow-y-auto p-3.5 sm:p-6 lg:p-8 space-y-6 max-w-4xl mx-auto w-full text-[#F8FAFC]">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#10B981]/25 pb-4 sm:pb-5">
        <div>
          <h1 className="text-lg sm:text-xl font-bold tracking-tight text-[#F8FAFC] flex items-center gap-2.5">
            <SettingsIcon className="h-5 w-5 sm:h-6 sm:w-6 text-[#00D9A5]" />
      ...
      <form onSubmit={handleSave} className="space-y-6 text-xs">
        ...
        {/* ======================================================== */}
        <div className="rounded-2xl bg-[#010e09] p-4 sm:p-6 border border-[#10B981]/25 space-y-4 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-[#10B981]/20">
            <h2 className="text-sm font-bold text-[#F8FAFC] uppercase tracking-wider flex items-center gap-2">
              <Globe className="h-4 w-4 text-[#00D9A5]" />
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-[#10B981]/20 hover:bg-[#10B981]/30 px-3 py-1.5 text-xs font-semibold text-[#00D9A5] border border-[#10B981]/40 transition-all self-start sm:self-auto shadow-sm cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl bg-[#010e09] px-3.5 py-2.5 text-xs sm:text-sm text-[#F8FAFC] border border-[#10B981]/25 focus:outline-none focus:border-[#10B981]"
              >
            ...
            <div className="rounded-xl bg-[#010e09] p-3.5 border border-[#10B981]/20 flex flex-col justify-between">
              <div>
              ...
              <div className="mt-2.5 pt-2 border-t border-[#10B981]/15 flex items-center justify-between text-[11px] text-[#94A3B8]">
        ...
        <div className="rounded-2xl bg-[#010e09] p-4 sm:p-6 border border-[#10B981]/25 space-y-4 shadow-xl">
          <h2 className="text-sm font-bold text-[#F8FAFC] uppercase tracking-wider flex items-center gap-2">
            <Cpu className="h-4 w-4 text-[#00D9A5]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl bg-[#010e09] px-3.5 py-2.5 text-[#F8FAFC] border border-[#10B981]/25 focus:outline-none focus:border-[#10B981]"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl bg-[#010e09]/60 px-3.5 py-2.5 text-[#94A3B8] border border-[#10B981]/20 cursor-not-allowed"
              />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-[#010e09] p-4 sm:p-6 border border-[#10B981]/25 space-y-4 shadow-xl">
          <h2 className="text-sm font-bold text-[#F8FAFC] uppercase tracking-wider flex items-center gap-2">
            <Shield className="h-4 w-4 text-[#00D9A5]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl bg-[#010e09] px-3.5 py-2.5 text-[#F8FAFC] border border-[#10B981]/25 focus:outline-none"
              >
          ...
          <div className="space-y-3 pt-2">
            <label className="flex items-center justify-between p-3 rounded-xl bg-[#010e09] border border-[#10B981]/20 cursor-pointer">
              <div>
            ...
            <div className="pt-3 border-t border-[#10B981]/15 space-y-3">
              <span className="text-[11px] font-bold tracking-wider text-[#00D9A5] uppercase block">
                Delegated Authority & Autopilot Settings
              </span>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label className="flex items-center justify-between p-3 rounded-xl bg-[#010e09] border border-[#10B981]/15 cursor-pointer">
                  <div>
                  ...
                  <input
                    ...
                    className="h-3.5 w-3.5 rounded accent-[#10B981] shrink-0 ml-2"
                  />
                </label>
            ...
            <div className="p-3 rounded-xl bg-[#010e09] border border-[#10B981]/20 flex items-center justify-between">
              <div>
        ...
        {/* ======================================================== */}
        <div className="rounded-2xl bg-[#010e09] p-4 sm:p-6 border border-[#10B981]/35 space-y-5 shadow-xl relative overflow-hidden">
          {/* Natural Forest Glow Accent */}
          <div className="pointer-events-none absolute -right-12 -bottom-12 h-44 w-44 rounded-full bg-[#10B981]/10 blur-[80px]" />

          <div className="flex items-center justify-between border-b border-[#10B981]/20 pb-3">
            <h2 className="text-sm font-bold text-[#F8FAFC] uppercase tracking-wider flex items-center gap-2">
              <Smartphone className="h-4 w-4 text-[#00D9A5]" />
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-9 h-5 bg-[#010e09] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-[#94A3B8] peer-checked:after:bg-[#00D9A5] after:border-gray-500 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-emerald-950 border border-[#10B981]/20"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1">
            <div className="rounded-xl bg-[#010e09]/80 p-3.5 border border-[#10B981]/15">
              <span className="block text-[10px] font-bold text-[#94A3B8] uppercase tracking-wider mb-2 flex items-center gap-1">
                <Clock className="h-3.5 w-3.5 text-[#00D9A5]" />
                Response Threshold
              </span>
              <div className="flex items-center gap-2">
                <input 
                  ...
                  className="w-16 rounded-lg bg-[#010e09] px-2.5 py-1.5 text-xs text-[#F8FAFC] border border-[#10B981]/20 focus:outline-none focus:border-[#10B981] font-mono text-center"
                />
            ...
            <div className="rounded-xl bg-[#010e09]/80 p-3.5 border border-[#10B981]/15">
              <span className="block text-[10px] font-bold text-[#94A3B8] uppercase tracking-wider mb-2 flex items-center gap-1">
                <MessageSquare className="h-3.5 w-3.5 text-[#00D9A5]" />
                Brand Persona Tone
              </span>
              <select
                value={waTone}
                onChange={(e) => setWaTone(e.target.value as any)}
                className="w-full rounded-lg bg-[#010e09] px-2.5 py-1.5 text-xs text-[#F8FAFC] border border-[#10B981]/20 focus:outline-none"
              >
          ...
          <div className="rounded-xl bg-[#010e09]/50 p-4 border border-[#10B981]/20 space-y-3.5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#10B981]/10 pb-2.5">
              <div>
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="rounded-lg bg-[#010e09] px-2.5 py-1 text-xs text-[#F8FAFC] border border-[#10B981]/20 focus:outline-none font-medium"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg bg-[#10B981] hover:bg-[#065f46] disabled:opacity-50 px-3 py-1 text-xs font-bold text-white cursor-pointer transition-colors"
                >
            ...
            {simStatus !== 'idle' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5">
                ...
                <div className="rounded-lg bg-[#010e09] p-3 border border-[#10B981]/15 font-mono text-[10px] space-y-1.5 max-h-48 overflow-y-auto">
                  <div className="flex items-center justify-between text-[#94A3B8] border-b border-[#10B981]/10 pb-1 mb-1.5 font-sans">
                    <span>TIMELINE LOGS</span>
                    <span className="text-[9px] font-mono text-[#00D9A5]">SPEEDED x100</span>
                  </div>
                  {simLog.map((log, i) => (
                    <div key={i} className={`leading-relaxed ${log.includes('🚨') ? 'text-amber-500 font-semibold' : log.includes('🚀') || log.includes('✨') ? 'text-[#00D9A5] font-semibold' : 'text-[#94A3B8]'}`}>
                      {log}
                    </div>
                  ))}
                  ...
                  {simStatus === 'waiting' && (
                    <div className="space-y-1.5 font-sans pt-1">
                      <div className="flex items-center justify-between text-[9px] text-[#64748B]">
                        ...
                        <span className="font-mono text-[#00D9A5] font-bold">{simProgress}%</span>
                      </div>
                      <div className="w-full bg-[#010b07] rounded-full h-1.5 overflow-hidden">
                        <div className="bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] h-1.5 transition-all duration-300" style={{ width: `${simProgress}%` }} />
                      </div>
                    </div>
                  )}
                ...
                <div className="rounded-lg bg-[#010e09] p-3 border border-[#10B981]/15 flex flex-col justify-between">
                  <div>
                    <div className="text-[9px] font-bold text-[#94A3B8] tracking-wider uppercase mb-1.5">
                      DISPATCHED OUTBOX RESPONSE
                    </div>
                    {simDraft ? (
                      <p className="text-xs text-[#F8FAFC] leading-relaxed bg-[#065f46]/20 p-2.5 rounded-xl border border-[#10B981]/10 whitespace-pre-wrap">
                        {simDraft}
                      </p>
                    ) : (
        ...
        <div className="flex justify-end">
          <button
            ...
            className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] hover:brightness-110 px-6 py-2.5 text-xs font-bold text-white shadow-lg shadow-[#10B981]/20 transition-all cursor-pointer"
          >
        ...
        <div className="rounded-2xl bg-[#010e09] p-4 sm:p-6 border border-rose-500/30 space-y-4 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-xl bg-[#010e09] px-4 py-2.5 text-xs font-semibold text-[#F8FAFC] border border-[#10B981]/25 hover:bg-[#10B981]/15 transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-xl bg-rose-500/15 px-4 py-2.5 text-xs font-semibold text-rose-300 border border-rose-500/40 hover:bg-rose-500/25 transition-colors cursor-pointer"
            >

    ...
    <div id="files_view" className="flex-1 overflow-y-auto p-3.5 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto w-full text-[#F8FAFC]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#10B981]/25 pb-4 sm:pb-5">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-[#F8FAFC] flex items-center gap-2.5">
            <FolderOpen className="h-6 w-6 text-[#00D9A5]" />
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-2xl bg-[#010e09] px-3.5 py-2.5 text-xs font-semibold text-[#F8FAFC] border border-[#10B981]/25 hover:bg-[#10B981]/15 transition-colors cursor-pointer"
          >
            <Plus className="h-4 w-4 text-[#00D9A5]" />
            <span>{t.newFile}</span>
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-2xl bg-gradient-to-r from-[#065f46] via-[#854D0E] to-[#10B981] hover:brightness-110 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-[#10B981]/20 transition-all cursor-pointer"
          >
      ...
      <div
        ...
        className={`cursor-pointer rounded-2xl border-2 border-dashed p-6 text-center transition-all ${
          isDragOver
            ...
            : 'border-[#10B981]/25 bg-[#010e09] hover:border-[#10B981]/60 hover:bg-[#10B981]/10'
        }`}
      >
        <UploadCloud className="mx-auto h-8 w-8 text-[#00D9A5] mb-2" />
            ...
            <div>
              <div className="flex items-center justify-between gap-2 mb-2">
                <div className="flex items-center gap-2.5">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#010e09] border border-[#10B981]/20">
                    {getFileIcon(file.category, file.extension)}
                  </div>
                  <div>
                    <h3 className="text-xs font-bold text-[#F8FAFC] truncate max-w-[160px] group-hover:text-[#00D9A5] transition-colors">
                      {file.name}
                    </h3>
              ...
              {/* Snippet Preview */}
              <div className="mt-2.5 rounded-xl bg-[#010e09] p-2.5 font-mono text-[10px] text-[#94A3B8] border border-[#10B981]/15 line-clamp-3 leading-relaxed">
            ...
            <div className="mt-4 pt-3 flex items-center justify-between border-t border-[#10B981]/15">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="rounded-lg p-1.5 text-[#94A3B8] hover:bg-[#010e09] hover:text-[#F8FAFC]"
                  title="Preview File"
                >
      ...
      {selectedFile && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
          <div className="w-full max-w-2xl rounded-2xl bg-[#010e09] p-6 border border-[#10B981]/30 shadow-2xl space-y-4">
            ...
            <div className="max-h-96 overflow-y-auto rounded-xl bg-[#010e09] p-4 border border-[#10B981]/25 font-mono text-xs text-[#F8FAFC] whitespace-pre-wrap leading-relaxed">
              {selectedFile.content || 'Empty or binary content'}
            </div>

            <div className="flex items-center justify-between pt-3 border-t border-[#10B981]/25">
              <button
                onClick={() => handleDownloadFile(selectedFile)}
                className="flex items-center gap-1.5 rounded-xl bg-[#010e09] px-3.5 py-2 text-xs font-semibold text-[#F8FAFC] border border-[#10B981]/25 hover:bg-[#10B981]/15"
              >
                <Download className="h-3.5 w-3.5" />
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setSelectedFile(null)}
                  className="rounded-xl px-4 py-2 text-xs text-[#94A3B8] hover:bg-[#010e09]"
                >
                  {t.closeModal}
                </button>
                <button
      ...
      {isCreateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl bg-[#010e09] p-6 border border-[#10B981]/30 shadow-2xl">
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl bg-[#010e09] p-3 text-[#F8FAFC] border border-[#10B981]/25 focus:outline-none font-mono text-xs"
                />
              </div>
